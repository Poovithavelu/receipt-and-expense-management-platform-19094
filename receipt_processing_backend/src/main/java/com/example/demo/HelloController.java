...
/**
 * Basic endpoints for service availability checks and documentation redirection.
 */
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for receiptprocessingbackend")
public class HelloController {

    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to receiptprocessingbackend";
    }
